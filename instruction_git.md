...
В случае если работа с новой веткой завершена или эта ветка стала неактуальна, ее можно и нужно удалить. Для этого мы воспользуемся уже известной нам командой (branch)  с обязательный использованием флага (-d) и именем удаляемой ветки.
