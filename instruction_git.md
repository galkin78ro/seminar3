...
Ветвление позволяет проводить работу с исходным файлом несколькими пользователями, а так же контролировать внесенные изменения
...
Если после команды (branch) ничего не будет, то будет выведена информация по всем существующим веткам. Возле ветки активной в данный момент будет звездочка, а имя окрашено в зеленый цвет
