...
В случае если работа с новой или созданной ранее веткой завершена или же какая то ветка стала неактуальна, ее можно и нужно удалить. Для этого мы воспользуемся уже известной нам командой (branch)  с обязательный использованием флага (-d) и именем удаляемой ветки.

    git dranch -d <name branch del>
